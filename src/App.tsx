...
function App() {
  ...
  const tourSteps = [
    {
      ...
      description:
        "Sign up using a familiar email and password interface. Under the hood, ReBlocks secures your account instantly without forcing you to manage private keys or crypto wallets.",
    ...
    },
    {
      ...
      description:
        "Fast identity verification to ensure regulatory compliance and account safety. Unlocks full transaction limits for cross-border remittances within minutes.",
      keywords: [
        "Identity Protection",
        "Regulatory Compliance",
        "Secure Limits",
      ],
      images: ["/screenshots/profile page unverified kyc.png"],
    },
    {
      title: "x402 AI Agent",
      ...
      description:
        "Turn complex cross-border transfers into a simple conversation. Just tell our AI who to pay, and it handles the live FX rates, L2 routing, and local payout instantly.",
    ...
    },
    {
      ...
      description:
        "Looks and feels like a modern financial app. Manage local payout recipients, view balances, and track your transparent on-chain transaction history with zero friction.",
    ...
    },
    {
      ...
      description:
        "Local funds are on-ramped to stablecoins and securely locked by our smart contract. Upon verification, funds are released to local off-ramps for payout, emitting real-time L2 events and a verifiable Tx Hash.",
      keywords: [
        "Regional E-Wallets",
        "Server-Side Routing",
  ...
  const buildDiaries = [
    {
      label: "Update #1",
      url: "https://x.com/gubsiclez/status/2057131970766016535?s=20",
      desc: "Concept, L2 remittance problem, and Morph integration",
    },
    {
      label: "Update #2",
      url: "https://x.com/gubsiclez/status/2057517699413254325?s=20",
      desc: "Designing the recipient and sender mobile experiences",
    },
    {
      label: "Update #3",
      url: "https://x.com/gubsiclez/status/2057884201450709293?s=20",
      desc: "Smart contract backend and Morph Network bridging",
    },
    {
      label: "Update #4",
      url: "https://x.com/gubsiclez/status/2060018033184378886?s=20",
      desc: "Interactive Appetize demo & testnet beta launch",
    },
  ];
    ...
    <>
      ...
      <header id="site-header">
        ...
        <nav className="header-nav desktop-nav">
          <a
            href="https://canva.link/xll4nm7mq0mobil"
            target="_blank"
          ...
          <a
            href="https://x.com/gubsiclez/status/2058208780131999981?s=20"
            target="_blank"
            rel="noopener noreferrer"
            className="nav-link"
          >
          ...
          <div className="nav-dropdown-wrapper" ref={dropdownRef}>
            ...
            >
              Build Diaries
              <svg
                className={`chevron-icon ${diaryDropdownOpen ? "open" : ""}`}
                width="10"
                height="6"
                viewBox="0 0 10 6"
                fill="none"
          ...
          <a
            href="https://imgur.com/a/zOPh0tT"
            target="_blank"
            rel="noopener noreferrer"
            className="nav-link"
          >
          ...
          <a
            href="https://github.com/mtrsvn/ReBlocks"
            target="_blank"
            rel="noopener noreferrer"
            className="nav-link"
          >
        ...
        <div className={`mobile-nav ${menuOpen ? "open" : ""}`}>
          ...
          <div className="mobile-accordion-wrapper">
            ...
            >
              ...
              <svg
                className={`chevron-icon ${mobileDiaryOpen ? "open" : ""}`}
                width="10"
                height="6"
                viewBox="0 0 10 6"
                fill="none"
      ...
      <section id="hero">
        <div className="hero-content">
          ...
          >
            ...
            smart contract-secured, near-instant 24/7 global settlements.
          </p>
        ...
        <div className="tour-container">
          <div className="tour-header">
            ...
            <p className="tour-section-desc">
              Take a walk through our instant L2 cross-border remittance
              protocol. Click through the technical breakthroughs below to see
              how our x402 AI Agent and Morph architecture make sending money
              home as easy as sending a text.
            </p>
          </div>
              ...
              <div className="tour-viewer-container">
                {tourSteps[activeStep].images.length > 1 && (
                  <>
                    <button
                      ...
                      onClick={() =>
                        setActiveSubImage(Math.max(0, activeSubImage - 1))
                      }
                ...
                <div className="tour-viewer-frame">
                  <div
                    ...
                    style={{
                      transform: `translateX(-${activeSubImage * 100}%)`,
                    }}
                  >
                    {tourSteps[activeStep].images.map((img, idx) => (
                      <div
                        key={idx}
                        className={`tour-carousel-slide ${idx === activeSubImage ? "active" : ""}`}
                      >
                        <img
                          src={img}
      ...
      <section id="cta">
        <div className="cta-content">
          ...
          <p className="cta-subtitle">
            Experience the fastest, cheapest way to send money home. Try the
            live interactive demo or download the app today.
          </p>
      ...
      {localModalOpen && (
        <div className="modal-overlay" onClick={() => setLocalModalOpen(false)}>
          <div
            className="modal-container local-modal-container"
          ...
          >
            ...
            <div className="modal-body local-modal-body">
              ...
              <div className="tutorial-section">
                <h4 className="tutorial-section-title">
                ...
                <div className="step-list">
                  <div className="step-item">
                    ...
                    <div className="step-content">
                      ...
                      <div className="code-block-wrapper">
                        <pre>
                          <code>{`git clone https://github.com/mtrsvn/ReBlocks\ncd ReBlocks`}</code>
                        </pre>
                        <button
                  ...
                  <div className="step-item">
                    ...
                    <div className="step-content">
                      ...
                      <p className="step-desc">
                        Scan the QR code displayed in your terminal using your
                        physical device's camera to load the application
                        instantly.
                      </p>
                    </div>
                  </div>
